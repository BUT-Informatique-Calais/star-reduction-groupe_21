...
import matplotlib.pyplot as plt  #pour sauvgarder les images
...
if data.ndim == 3:  #verifier si l'image est en couleur 3 dimensions (height, width, channels)
...
# Perform erosion
eroded_image = cv.erode(image, kernel, iterations=4)
